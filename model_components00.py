...
class maskCNNModel0(nn.Module):
    def __init__(self, opts):
        ...
        self.conv = nn.Sequential(
            ...
            nn.Conv2d(opts.x_image_channel*opts.stack_imgs, 64*opts.stack_imgs, kernel_size=(1, 7), dilation=(1, 1)),
            nn.BatchNorm2d(64*opts.stack_imgs), nn.ReLU(),

            # cnn2
            nn.ZeroPad2d((0, 0, 3, 3)),
            nn.Conv2d(64*opts.stack_imgs, 64*opts.stack_imgs, kernel_size=(7, 1), dilation=(1, 1)),
            nn.BatchNorm2d(64*opts.stack_imgs), nn.ReLU(),

            # cnn3
            nn.ZeroPad2d(2),
            nn.Conv2d(64*opts.stack_imgs, 64*opts.stack_imgs, kernel_size=(5, 5), dilation=(1, 1)),
            nn.BatchNorm2d(64*opts.stack_imgs), nn.ReLU(),

            # cnn4
            nn.ZeroPad2d((2, 2, 4, 4)),
            nn.Conv2d(64*opts.stack_imgs, 64*opts.stack_imgs, kernel_size=(5, 5), dilation=(2, 1)),
            nn.BatchNorm2d(64*opts.stack_imgs), nn.ReLU(),

            # cnn5
            nn.ZeroPad2d((2, 2, 8, 8)),
            nn.Conv2d(64*opts.stack_imgs, 64*opts.stack_imgs, kernel_size=(5, 5), dilation=(4, 1)),
            nn.BatchNorm2d(64*opts.stack_imgs), nn.ReLU(),

            # cnn6
            nn.ZeroPad2d((2, 2, 16, 16)),
            nn.Conv2d(64*opts.stack_imgs, 64*opts.stack_imgs, kernel_size=(5, 5), dilation=(8, 1)),
            nn.BatchNorm2d(64*opts.stack_imgs), nn.ReLU(),

            # cnn7
            nn.ZeroPad2d((2, 2, 32, 32)),
            nn.Conv2d(64*opts.stack_imgs, 64*opts.stack_imgs, kernel_size=(5, 5), dilation=(16, 1)),
            nn.BatchNorm2d(64*opts.stack_imgs), nn.ReLU(),

            # cnn8
            nn.Conv2d(64*opts.stack_imgs, 8, kernel_size=(1, 1), dilation=(1, 1)),
        ...
        self.fc3 = nn.Linear(opts.fc1_dim, opts.freq_size * opts.y_image_channel * opts.stack_imgs)
