...
def create_parser(): 
    ...
    parser.add_argument('--w_image', type=float, default=2048, help='The scaling factor for the imaging loss') 
    ...
    parser.add_argument("--snr_list", nargs='+', default=[-1,], type=float)  # for train: -25:0, test: -40, 16 
    ...
    parser.add_argument('--terminate_acc', type=float, default=0.95) 
